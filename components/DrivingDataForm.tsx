...
// // import InputField from "@/components/InputField";
// // import Button from "@/components/Button";
// // import { api, DrivingData, DrivingResponse } from "@/utils/api";

// // interface DrivingDataFormProps {
// //   onSubmitSuccess: (result: DrivingResponse) => void;
// //   onResetForm: () => void;
// // }

// // export default function DrivingDataForm({ onSubmitSuccess, onResetForm }: DrivingDataFormProps) {
// //   const [driverId, setDriverId] = useState("");
// //   const [acceleration, setAcceleration] = useState("");
// //   const [braking, setBraking] = useState("");
// //   const [turn, setTurn] = useState("");
...
// //       console.log("Submitting driving data:", data);
